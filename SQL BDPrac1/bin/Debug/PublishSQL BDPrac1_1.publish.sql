/*
Script de implementación para DB1Prac1
...
GO
:setvar DatabaseName "DB1Prac1"
:setvar DefaultFilePrefix "DB1Prac1"
...
ALTER TABLE [dbo].[APODERADO]
    ADD CONSTRAINT [FK_APODERADO_ALUMNO] FOREIGN KEY ([id_Alumnos]) REFERENCES [dbo].[ALUMNO] ([Id]);
...
GO
ALTER TABLE [dbo].[INSCRITO]
    ADD CONSTRAINT [FK_INSCRITO_CURSO] FOREIGN KEY ([Cod_Curso]) REFERENCES [dbo].[CURSO] ([Codigo]);
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '1a6a0e80-1acc-4411-b0ad-82027eb261dd')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('1a6a0e80-1acc-4411-b0ad-82027eb261dd')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'f4458552-1c4f-49ce-8a71-672ff9a0ca54')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('f4458552-1c4f-49ce-8a71-672ff9a0ca54')
