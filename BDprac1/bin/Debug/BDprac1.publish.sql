/*
Script de implementación para BDprac1
...
GO
:setvar DatabaseName "BDprac1"
:setvar DefaultFilePrefix "BDprac1"
...
GO
ALTER TABLE [dbo].[INSCRITO]
    ADD CONSTRAINT [FK_INSCRITO_CURSO] FOREIGN KEY ([Cod]) REFERENCES [dbo].[CURSO] ([Cod]);
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '969431bc-70f8-4389-8c86-318a75706ff4')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('969431bc-70f8-4389-8c86-318a75706ff4')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '6b97cfb9-8d77-4e75-a2d8-d3877c644290')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('6b97cfb9-8d77-4e75-a2d8-d3877c644290')
